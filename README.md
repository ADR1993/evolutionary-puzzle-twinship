...
This repository contains the data and code used to generate the plots and maps in the manuscript *A Gene-Culture Co-Evolutionary Perspective on the Evolutionary Puzzle of Human Twinship*.

Citation (pre-print): Dalla Ragione, A., Ross C.T., and Redhead, D. (2023). A Gene-Culture Co-Evolutionary Perspective on the Evolutionary Puzzle of Human Twinship. DOI: [doi.org/10.32942/X2QP5X](https://doi.org/10.32942/X2QP5X). EcoEvoRxiv.
